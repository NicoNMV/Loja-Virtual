...
<h-8">
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">tml lang="pt-br">
...
<body>
  ...
  $consulta = $cn->query("select nm_livro, ds_capa, vl_preco, qt_estoque from vw_livro where ds_categoria = '$cat'");
  ?>
